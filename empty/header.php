    ...
    <link href="scripts/jquery/themes/ui-lightness/jquery-ui-1.8.23.custom.css" rel="stylesheet" type="text/css" />
    <script src="scripts/jquery/jquery-1.8.2.min.js" type="text/javascript"></script>
    <script src="scripts/jquery/jquery-ui-1.8.23.custom.min.js" type="text/javascript"></script>
